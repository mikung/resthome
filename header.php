...
include 'connection/connect_mainlogin.php';
//===ชื่อโรงพยาบาล
if ($db) {
        ...
        <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand logo-mini" href="index.php?unset=1"><img alt="Brand" src="images/agency.ico" width='35'> 
                        <font color='#ffff00'><b>HUMAN RESOURCE DEVELOPMENT</b> : <b>HRD S</b>ystem</font>
                    </a>
                </div>
            </div>
...
<?PHP } else { ?>
    ...
    <?php if ($_SESSION['Status'] == '1' ) { ?>
                                    ...
                                    <li><a href="pre_leave.php?unset=1"><img src='images/Lfolder.ico' width='25'> เขียนใบลา</a></li>
        ...
        <?php //} ?>
                        ...
                        <li class="dropdown user-dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src='images/personal.ico' width='20'> 
                                ...
                                if ($user_id != '') {
                                    $sql = mysqli_query($mysql, "SELECT   p.ID_Personnal,CONCAT(p1.PreName,p.`Name`,' ',p.Lastname) `Name` FROM `personnal` p LEFT JOIN prename p1 on (p.ID_Prename=p1.ID_Prename)
WHERE p.ID_Personnal='$user_id'");
