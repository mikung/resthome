            ...
            <form id="defaultForm" method="post" class="form-horizontal" action="ins_formborrow.php">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <select class="form-control select2" id="groupJName" name="groupJName" required>
                            <option value="">เลือกกลุ่มวิชาชีพ</option>
                            <?php
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <div class="radio">
                            <label>
                                <input type="radio" name="typef_id" id="optionsRadios1" value="1" checked>
                                โสด</label>
                        </div>
                        <div class="radio">
                            <label>
                                <input type="radio" name="typef_id" id="optionsRadios1" value="2">
                                ครอบครัว
                            </label>
                        </div>
                    </div>
                ...
                <div class="box-footer">
                    <div class="col-lg-9 col-lg-offset-6">
                        <button type="button" id="insertdata" class="btn btn-success">ส่งข้อมูล
                        </button>
                    </div>
                </div>
            </form>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(data){
                        ...
                        setInterval(function (){ $(location).attr('href','indexadmin.php'); },2000);
                    }else{
