    ...
    <section class="content">
        <div class="box box-warning">
            <div class="box-header with-border">
                <h3 class="box-title">คิวคืนบ้านพัก</h3>
            </div>
                       <!-- START CUSTOM TABS -->
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                ...
                                                                <button type="submit" class="btn btn-success" style="width: 110px">อนุมัติเรียบร้อย
                                                                </button>
...
";
                                                    ...
                                                    foreach ($results as $value){
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div>
                                                                    <button type="submit" class="btn btn-success" style="width: 80px">รับเอกสาร
                                                                    </button>
                                                                    <button type="submit" class="btn btn-warning" style="width: 100px">อนุมัติเอกสาร
                                                                    </button>
                                                                    <button type="submit" class="btn btn-primary" style="width: 80px">ยกเลิก
                                                                    </button>
                                                                </div>
                                                            </td>
                                                        </tr>
